Programming of Internet Applications project that consists of an Angular v16 app for frontend, Node.js with Express app for backend and a Mongo database.<br>
